package com.alarm.monitor.utils;
...
public class SerialPortManager {
    private final static Logger logger = LoggerFactory.getLogger(SerialPortManager.class);
    ...
    public static String sendToPort(SerialPort serialPort, byte[] order) {
        ...
        logger.debug("结果：" + ByteUtils.byteArrayToHexString(data));
